...
\geometry{left=1.4cm, top=2.8cm, right=1.4cm, bottom=2.8cm, footskip=.5cm}
...
\name{Nan}{Wu}
\position{Software Engineer{\enskip\cdotp\enskip}Squad Tech lead}
